                    ...
                    # Handle date columns - standardize format with better parsing
                        ...
                        try:
                            ...
                            if 'sdid' in source_col.lower():
                                ...
                                logger.info(f"Target column type before conversion: {target[source_col].dtype}")
